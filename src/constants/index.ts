...
export const VBE = new Token(ChainId.MATIC, '0x01450A6E5aF39480DeB113DC7405b7E8521e87f9', 18, 'VBE', 'VBE')
...
export const UNI: { [chainId in ChainId]: Token } = {
 ...
 // [ChainId.MATIC]: new Token(ChainId.MATIC, '0x35db0dfb42dfe164a3e4d39f91459878d564fa5b', 5, 'SPYRIT', 'SpyritCoin')
  [ChainId.MATIC]: new Token(ChainId.MATIC, '0x01450A6E5aF39480DeB113DC7405b7E8521e87f9', 18, 'VBE', 'VBE')
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [VBE,...WETH_ONLY[ChainId.MAINNET],  DAI, USDC, USDT, WBTC]
}
