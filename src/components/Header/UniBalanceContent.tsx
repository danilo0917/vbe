  ...
  return (
    <ContentWrapper gap="lg">
      <ModalUpper>
        ...
        <CardSection gap="md">
          <RowBetween>
            <TYPE.white color="white">Your VBE Breakdown</TYPE.white>
        ...
        <CardSection gap="sm">
          <AutoColumn gap="md">
            <RowBetween>
              <TYPE.white color="white">VBE price:</TYPE.white>
              <TYPE.white color="white">${uniPrice?.toFixed(3) ?? '-'}</TYPE.white>
            </RowBetween>
            <RowBetween>
              <TYPE.white color="white">VBE in circulation:</TYPE.white>
            ...
            {/* {uni && uni.chainId === ChainId.MATIC ? (
              <ExternalLink href={`https://info.quickswap.exchange/token/${uni.address}`}>View VBE Analytics</ExternalLink>
            ) : null} */}
          </AutoColumn>
        </CardSection>
      </ModalUpper>
